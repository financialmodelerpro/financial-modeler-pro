 ...
 * Mark-Complete button's visibility on the watch page (gate:
 * `canMarkComplete = bypassActive || thresholdMet`), but they are not
 * surfaced to students in any form: no bar, no number, no "X% to go"
 * countdown. Exposing the rule incentivises skipping to hit the
 * threshold; keeping it silent means the student simply watches the
 * video and the button appears when they're done.
 *

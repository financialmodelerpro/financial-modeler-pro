...
export const PLATFORMS: Platform[] = [
  {
    ...
    modules: [
      ...
      },
      {
        ...
        description: 'Side-by-side scenario comparison with toggle assumptions and sensitivity tables.',
        status: 'planned',
        tabs: ['Side-by-side base / upside / downside', 'One-variable and two-variable sensitivity tables', 'Tornado charts on key drivers'],
      },
      {
        number: 8,
        name: 'Portfolio',

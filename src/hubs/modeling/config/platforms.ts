...
export const PLATFORMS: Platform[] = [
  {
    ...
    modules: [
      ...
      {
        number: 2,
        name: 'Revenue & Sales Projections',
      ...
      {
        number: 5,
        name: 'Returns & Valuation Analysis',
        description: 'Calculate project-level and equity-level returns including IRR, NPV, equity multiple, and payback period, plus per-partner returns and lender covenant checks.',
        status: 'complete',
        tabs: ['Project Returns', 'Equity Returns', 'Per-Partner Returns', 'RE Metrics'],
      },
      {
        number: 6,
        name: 'Scenario Analysis',
        description: 'Build override cases on top of the management base case and compare them side by side, with a per-period year-on-year impact view for every changed assumption.',
        status: 'complete',
        tabs: ['Case List', 'Assumptions Grid', 'Comparison Matrix', 'Year-on-Year Impact'],
      },
      {
        number: 7,
        name: 'IC Presentation Builder',
        description: 'A PowerPoint-style slide editor whose figures stay linked to the model, so the investment committee deck updates itself as Modules 1 to 6 change. Exports to editable PowerPoint and PDF.',
        status: 'in_progress',
        tabs: ['Slide Navigator', 'Canvas Editor', 'Live Model Bindings', 'PowerPoint / PDF Export'],
      },
      {
        number: 8,
        name: 'Portfolio',
        description: 'Roll-up across multiple projects with consolidated returns and waterfall.',
        status: 'planned',
        tabs: ['Multi-project roll-up', 'Consolidated returns', 'Sponsor / LP waterfall'],
      },
      {
        number: 9,
        name: 'Market Data',
        description: 'Live market comps, Saudi-specific data layer, and AI-driven assumption suggestions.',
        status: 'planned',
        tabs: ['Saudi market comps (rents, sale prices, occupancy)', 'AI assumption suggestions', 'Cap rate library'],
      },
      {
        number: 10,
        name: 'Collaborate',
        description: 'Multi-user editing, comments, and approval workflows for IC and lender review.',
        status: 'planned',
        tabs: ['Multi-user concurrent editing', 'In-cell comments and threads', 'IC approval workflow', 'Version compare across users'],
      },
      {
        number: 11,
        name: 'API Access',
        description: 'Programmatic access to your models for portfolio dashboards and downstream BI integration.',
        status: 'planned',
        tabs: ['REST API for project state', 'Webhook events on save / version', 'Bulk export to BI tools', 'Custom integrations'],
      },
    ],
  },

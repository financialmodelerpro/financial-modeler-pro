...
export const MODULES: readonly ModuleConfig[] = [
  ...
  },
  {
    ...
    disabled: false,
    plannedContent: [
      'IC report: snapshot-driven preview with a per-project narrative form',
      'Configurable sections (show/hide + reorder) and client fonts',
      'Export-ready report packs (PPT / PDF) in a later phase',

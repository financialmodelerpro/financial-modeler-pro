...
export const MODULES: readonly ModuleConfig[] = [
  ...
  },
  {
    ...
    longLabel: 'IC Presentation Builder',
    featureKey: 'module_7',
    requiredPlan: 'free',
    status: 'wip',
    disabled: false,
    plannedContent: [
      'Institutional slide deck built live from Modules 1 to 6',
      'Slide navigator, 16:9 canvas and a properties panel, like PowerPoint',
      'Every KPI, chart and table linked to the model, so the deck auto-updates',
      'Export to editable PowerPoint, PDF and image (later phase)',
    ],
  },
  {
    num: 8,

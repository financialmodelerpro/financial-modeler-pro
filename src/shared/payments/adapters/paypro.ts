...
export const payproAdapter: PaymentAdapter = {
  ...
  parseEvent(_rawBody: string): ParsedSubscriptionEvent {
    ...
    return { type: 'unknown', eventId: null, providerPriceOrProductId: null, userRef: null, customDataPlanKey: null, customerEmail: null, subscriptionId: null, customerId: null, customDataPlatform: null, transactionId: null, transactionAmountMinor: null, transactionCurrency: null, scheduledCancelAt: null };
  },
};

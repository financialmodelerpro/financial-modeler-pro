...
| `training_settings` | Admin config: apps_script_url, watch_enforcement_*, shuffle_*, modeling/training_hub_coming_soon, **share_brand_mention, share_founder_mention, share_brand_prefix_at, share_founder_prefix_at** (migrations 115-116), etc. |

...
| **Marketing Studio** | ✅ Complete (Phase 1) | `/admin/marketing-studio` — 3 templates (YouTube Thumbnail 1280x720, LinkedIn Post 1200x627, Instagram Post 1080x1080). Satori-based PNG rendering via `/api/admin/marketing-studio/render`. Brand Kit editor (logos, colors, founder photo) at `/admin/marketing-studio/brand-kit`. AI caption generator (LinkedIn / YouTube / Instagram / Twitter) via Anthropic Claude. Save/load designs via `marketing_designs` table. Debounced live preview, download PNG, per-design name + captions. Migration 100 |

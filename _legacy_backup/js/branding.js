...
const DEFAULT_BRANDING = {
    ...
    // White-label overrides (Admin-only)
    whiteLabel:        false,     // when true, clientName/clientLogo replace platform branding
    clientName:        '',        // white-label company name shown in toolbar
    clientLogo:        null,      // base64 data-URL of client logo, or null

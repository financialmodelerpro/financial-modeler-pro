...
export function EmailSettingsTab() {
  ...
  return (
    <div style={{ padding: 24, display: 'flex', flexDirection: 'column', gap: 24, maxWidth: 900 }}>
      {toast && (
        <div style={{ position: 'fixed', top: 80, right: 24, zIndex: 1000, padding: '10px 16px', background: '#2EAA4A', color: '#fff', borderRadius: 8, fontSize: 12, fontWeight: 700, boxShadow: '0 6px 18px rgba(0,0,0,0.18)' }}>
          {toast}
        </div>
      )}

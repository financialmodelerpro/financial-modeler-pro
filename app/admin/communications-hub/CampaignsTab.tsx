  ...
  return (
    <div style={{ padding: 32 }}>
      <div style={{ marginBottom: 24 }}>
        <p style={{ fontSize: 13, color: '#6B7280', margin: 0 }}>Send targeted emails to student groups and view campaign history</p>
      </div>

      <div style={{ display: 'flex', gap: 4, marginBottom: 24, background: '#fff', padding: 4, borderRadius: 8, width: 'fit-content', border: '1px solid #E8F0FB' }}>

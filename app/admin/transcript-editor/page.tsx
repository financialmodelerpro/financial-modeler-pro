...
export default function TranscriptEditorPage() {
  ...
  function deleteElem(k: ElemKey) {
    // Delete = hide + clear text (logo: clear URL)
    const vk = `${k}Visible` as keyof Settings;
  ...
  if (status === 'loading' || !session) return <div style={{ display:'flex',alignItems:'center',justifyContent:'center',height:'100vh',color:'#6B7280' }}>Loading…</div>;
    ...
    <div style={{ display:'flex', minHeight:'100vh', background:'#F3F4F6' }}>
      ...
      <div style={{ flex:1, display:'flex', flexDirection:'column', overflow:'hidden' }}>
        ...
        <div style={{ background:'#fff', borderBottom:'1px solid #E5E7EB', padding:'12px 20px', display:'flex', alignItems:'center', gap:10, flexWrap:'wrap' }}>
          <div>
            <h1 style={{ fontSize:17, fontWeight:800, color:'#111827', margin:0 }}>Transcript Editor</h1>
            <p style={{ fontSize:11, color:'#6B7280', margin:'2px 0 0' }}>Drag elements in the header. Click to select and edit.</p>
          </div>

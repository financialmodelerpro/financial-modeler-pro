                ...
                <div key={t.id} style={{ background:'#F9FAFB', border:`1px solid ${t.is_featured ? '#C9A84C' : '#E5E7EB'}`, borderRadius:14, padding:'24px', position:'relative', display:'flex', flexDirection:'column' }}>
                  ...
                  <div style={{ display:'flex', alignItems:'center', gap:10 }}>
                    ...
                    <div style={{ minWidth:0 }}>
                      ...
                      {t.linkedin_url && (
                        <a href={t.linkedin_url} target="_blank" rel="noopener noreferrer" style={{ display:'inline-flex', alignItems:'center', gap:5, marginTop:4, fontSize:'0.75rem', color:'#0A66C2', textDecoration:'none', fontWeight:500 }}>

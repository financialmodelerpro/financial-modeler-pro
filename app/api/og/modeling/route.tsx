...
/**
 * GET /api/og/modeling — Branded 1200x627 OG banner for Modeling Hub.
 */
  ...
  return new ImageResponse(
    (
      <div style={{
        ...
        {/* Background gradient */}
        <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(145deg, #0D2E5A 0%, #1B4F8A 45%, #2563EB 100%)', display: 'flex' }} />
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: 40 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
              ...
              <span style={{ fontSize: 13, color: 'rgba(255,255,255,0.5)', letterSpacing: '1.5px', textTransform: 'uppercase' as const }}>Modeling Hub</span>
            </div>
          </div>
          ...
          <div style={{ fontSize: 22, color: 'rgba(255,255,255,0.6)', lineHeight: 1.5, maxWidth: 700, marginBottom: 36 }}>
            Access professional templates, interactive models, and expert guidance for institutional-grade financial analysis
          </div>
          ...
          <div style={{
            ...
            <span style={{ fontSize: 16, fontWeight: 700, color: '#2EAA4A', letterSpacing: '0.5px' }}>Start Modeling Today</span>
          </div>
        </div>
        ...
        <div style={{
          ...
          <span style={{ fontSize: 15, color: 'rgba(255,255,255,0.35)', letterSpacing: '0.5px' }}>app.financialmodelerpro.com</span>
        </div>
      </div>
    ),

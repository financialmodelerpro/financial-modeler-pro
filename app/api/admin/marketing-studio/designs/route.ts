...
/** POST /api/admin/marketing-studio/designs — create new design */
export async function POST(req: NextRequest) {
  ...
  let body: { name?: string; template_type?: string; content?: Record<string, string>; ai_captions?: Record<string, string> };

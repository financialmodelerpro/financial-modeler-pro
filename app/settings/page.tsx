  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--color-bg)' }}>
      ...
      <header style={{
        ...
        <div style={{ flex: 1 }} />
        <a href={`${process.env.NEXT_PUBLIC_APP_URL ?? 'https://app.financialmodelerpro.com'}/refm`} style={{ color: 'rgba(255,255,255,0.7)', fontSize: 12, textDecoration: 'none', marginRight: 8 }}>← Platform</a>

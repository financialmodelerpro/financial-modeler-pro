...
**Last updated: 2026-05-12, M2.0 Costs Cleanup Pass 9 ships (8 fixes after mandatory diagnostic identified computeAssetBua had a narrower fallback than resolveAssetAreaMetrics; Land zero rendering survived 4 prior passes. Fix 8 patches computeAssetBua + computeAssetSellableBua to fall back to asset.buaSqm/sellableBuaSqm when sub-units sum to 0; MAAD fixture renders Land Cash 1,737M + Land In-Kind 434M. Verifier verify-m20costsCleanup-pass9.ts 37/0/0. Schema stays v8 additive.)**

...
**Last updated: 2026-04-27.** This session: (**Newsletter system rebuild — batch send, recipient log, segments, scheduling, Resend webhook, click tracking, signup opt-in, editable templates; Marketing Studio logo render fix (satori width:auto bug); LinkedIn banner gradient fix; Communications Hub consolidation; Marketing Studio flexibility upgrade earlier in the day**)

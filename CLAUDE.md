...
**Last updated: 2026-04-28.** This session: (**Follow-up admin cleanup — Branding merged into Header Settings (Brand Colors section, /admin/branding becomes redirect), Pricing Page Content tab removed (Page Builder canonical for hero + FAQ on /pricing), Pricing Plans tab removed entirely + migration 145 drops `pricing_plans` table. /admin/pricing reduced to a single Platform Pricing surface with no tab bar.** Prior 2026-04-27 work — multi-phase admin cleanup, Newsletter rebuild, Marketing Studio fixes, Communications Hub consolidation — kept verbatim below.)
